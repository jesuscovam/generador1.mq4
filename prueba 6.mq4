...
int start()
{
  ...
  {
     int result=0;
     if((Close[1]<iMA(NULL,PERIOD_M5,1000,0,MODE_EMA,PRICE_CLOSE,1))) // Here is your open buy rule
     {
     ...
     if((Close[1]>iMA(NULL,PERIOD_M5,1000,0,MODE_EMA,PRICE_CLOSE,1))) // Here is your open Sell rule
     {
